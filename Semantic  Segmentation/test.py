...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="runs/fcn8s_pascal/12988/fcn8s_pascal_best_model.pkl",
    ...
    parser.add_argument(
        "--img_path", nargs="?", type=str, default="/home/dgxuser125/gow/pytorch-semseg-master (1)1/VOCdevkit/VOC2007/JPEGImages/", help="Path of the input image"
    )
    parser.add_argument(
        "--out_path", nargs="?", type=str, default="/home/dgxuser125/gow/pytorch-semseg-master (1)1/pascaloutput/", help="Path of the output segmap"
    )
    args = parser.parse_args()
    for i in range(0,1001):
        inp="/home/dgxuser125/gow/pytorch-semseg-master (1)1/pplcatdog/" #path of the folder containing frames to be segmented 
        out1="/home/dgxuser125/gow/pytorch-semseg-master (1)1/pplout/"  #path of the folder where segmented frames has to be saved
        args.img_path=inp+"frame"+str(i)+".jpg"
        args.out_path=out1+"frame"+str(i)+".png"
        test(args)
