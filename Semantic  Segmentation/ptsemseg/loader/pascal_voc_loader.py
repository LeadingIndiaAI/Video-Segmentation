...
class pascalVOCLoader(data.Dataset):
    ...
    def setup_annotations(self):
        ...
        path = "/home/dgxuser125/gow/pytorch-semseg-master (1)1/benchmark/benchmark_RELEASE/dataset/train.txt"
        ...
        if len(pre_encoded) != expected:
            ...
            for ii in tqdm(sbd_train_list):
                lbl_path = pjoin("/home/dgxuser125/gow/pytorch-semseg-master (1)1/benchmark/benchmark_RELEASE/", "dataset/cls", ii + ".mat")
